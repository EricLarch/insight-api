...
AddressController.prototype.txApperances = function(req, res) {
  this.addressSummarySubQuery(req, res, 'txApperances');
};
...
AddressController.prototype.multitxs = function(req, res, next) {
  ...
  if((typeof req.query.start != 'undefined') || (typeof req.body.start != 'undefined'))
    options.start = parseInt(req.query.start) || req.body.start;
  if((typeof req.query.end != 'undefined') || (typeof req.body.end != 'undefined'))
    options.end = parseInt(req.query.end) || req.body.end;
